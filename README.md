...
This project contains the [Platform](https://eligere.merai.app/) and [Genetics](https://genetics.opentargets.org/) web applications. To run both in development mode, you can run: `yarn dev` in the root directory.
