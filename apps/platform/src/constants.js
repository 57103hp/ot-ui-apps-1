...
// App title.
export const appTitle = "Eligere";
export const appDescription =
  "The Eligere is a data integration tool that supports systematic drug target identification and prioritisation";
export const appCanonicalUrl = "https://eligere.merai.app";
